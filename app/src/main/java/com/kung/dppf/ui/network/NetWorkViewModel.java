package com.kung.dppf.ui.network;
...
public class NetWorkViewModel extends BaseViewModel<KungRepository> {
    ...
    public NetWorkViewModel(@NonNull Application application, KungRepository repository) {
